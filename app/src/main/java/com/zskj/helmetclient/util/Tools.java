...
public class Tools {
    ...
    public static final int CMD_OPEN_CONNECT_ACTIVITY = 22;// 打开客户端界面
    ...
    public void parse(Msg msg) {
        switch (msg.getMsgType()) {
            ...
            case Tools.CMD_OPEN_CONNECT_ACTIVITY:
                otherIp=msg.getReceiveUserIp();
                Tools.TipsMain(Tools.CMD_OPEN_CONNECT_ACTIVITY,msg.getBody());
                LogUtil.printI("YWQ","打开连接界面");
                break;
