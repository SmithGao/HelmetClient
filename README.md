...
## 你不知道的UDP传输(局域网)
  ...
  近日闲来无事 特将工作中研究过的小功能提出来，分享给大家。是一篇有关于UDP传输文件、视频的demo。当然 网上肯定已经存在很多了，我也只是将我自己研究的心得来在这里给大家讲一下，说的不好 大家多多担待 <img src="emoji/smile" width="18"/>。
...
---
 ...
 //发送消息线程
  ...
  同样需要启动线程，前面介绍了 防止数据在传输过程中出现问题，当然 假如真的出现了问题 我可以告诉你一个更简单的方法 ---重新发送！<img src="emoji/smile" width="18"/>
